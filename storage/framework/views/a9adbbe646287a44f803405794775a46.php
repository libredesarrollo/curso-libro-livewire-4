...
<head>
    ...
    <link rel="preload" as="font" type="font/woff2"
          href="<?php echo e(route('truss.asset', 'ibm-plex-mono-400.woff2')); ?>" crossorigin>

    <link rel="stylesheet" href="<?php echo e(route('truss.asset', 'truss.css')); ?>">

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasCustomTheme ?? false): ?>
        <link rel="stylesheet" href="<?php echo e(route('truss.theme')); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    
    <script src="<?php echo e(config('truss.diagram.mermaid_url') ?: route('truss.asset', 'mermaid.min.js')); ?>"></script>
</head>
<body>
    <div
        id="truss-app"
        data-schema-endpoint="<?php echo e(route('truss.api.schema')); ?>"
        data-export-endpoint="<?php echo e(route('truss.export', ['format' => '__format__'])); ?>"
        data-connections='<?php echo json_encode($connections, 15, 512) ?>'
        data-type-labels="<?php echo e(config('truss.diagram.type_labels')); ?>"
        data-warn-above="<?php echo e(config('truss.large_schema.warn_above')); ?>"
        data-focus-depth="<?php echo e(config('truss.focus.default_depth')); ?>"
        data-min-zoom="<?php echo e(config('truss.diagram.min_zoom')); ?>"
        data-doctor-flag-tables="<?php echo e(config('truss.doctor.flag_tables', true) ? '1' : '0'); ?>"
    >
    ...
    <script type="module" src="<?php echo e(route('truss.asset', 'truss.js')); ?>"></script>
</body>
</html>
<?php /**PATH /Users/andrescruz/Herd/livewirestore/vendor/albertoarena/laravel-truss/resources/views/index.blade.php ENDPATH**/ ?>