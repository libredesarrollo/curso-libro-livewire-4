...
This skill provides rules for designing Laravel tests. Each rule file explains what to do and why. Use ___SINGLE_BACKTICK___search-docs___SINGLE_BACKTICK___ for <?php echo e($pest ? 'Laravel and Pest API syntax' : 'Laravel API syntax'); ?>.<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $pest): ?> Fetch ___SINGLE_BACKTICK___https://docs.phpunit.de/en/13.3/___SINGLE_BACKTICK___ for PHPUnit API syntax.<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pest && $assist->hasPackage('pestphp/pest-plugin-browser')): ?>
...
<?php /**PATH /Users/andrescruz/Herd/livewirestore/storage/framework/views/8191862a69cfb489eb4df20db0ebbc14.blade.php ENDPATH**/ ?>