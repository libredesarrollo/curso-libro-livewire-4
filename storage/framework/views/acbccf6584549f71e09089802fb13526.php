        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col lg:max-w-5xl gap-8">
                ...
                <div class="text-center py-8 lg:py-12">
                    <h1 class="text-4xl lg:text-6xl font-semibold tracking-tight"><?php echo e(config('app.name', 'Livewire Store')); ?></h1>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="group block p-6 bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm hover:shadow-md transition-shadow">
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <a href="<?php echo e(route('web.index')); ?>" class="group block p-6 bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-3 mb-3">
                            <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-[#f53003]/10 dark:bg-[#FF4433]/10 text-[#f53003] dark:text-[#FF4433]">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="block p-6 bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="<?php echo e(route('demo.loading')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Loading</a>
                            <a href="<?php echo e(route('demo.data-loading')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Data Loading</a>
                            <a href="<?php echo e(route('demo.lazy')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Lazy</a>
                            <a href="<?php echo e(route('demo.computed')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Computed</a>
                            <a href="<?php echo e(route('demo.intersect')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Intersect</a>
                            <a href="<?php echo e(route('demo.wire-text')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Wire Text</a>
                            <a href="<?php echo e(route('demo.wire-ref')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Wire Ref</a>
                            <a href="<?php echo e(route('demo.filemanager')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">File Manager</a>
                            <a href="<?php echo e(route('teleport-example')); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Teleport</a>
                            ...
                            <a href="<?php echo e(route('contact-edit', 1)); ?>" class="text-xs px-2.5 py-1 rounded-md bg-[#f53003]/5 dark:bg-[#FF4433]/5 text-[#f53003] dark:text-[#FF4433] hover:underline">Contacto</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    <a href="<?php echo e(route('todo')); ?>" class="group block p-6 bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-3 mb-3">
                            <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-[#f53003]/10 dark:bg-[#FF4433]/10 text-[#f53003] dark:text-[#FF4433]">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <a href="<?php echo e(route('shop.cart.list')); ?>" class="group block p-6 bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-3 mb-3">
                            <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-[#f53003]/10 dark:bg-[#FF4433]/10 text-[#f53003] dark:text-[#FF4433]">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<?php /**PATH /Users/andrescruz/Herd/livewirestore/resources/views/welcome.blade.php ENDPATH**/ ?>