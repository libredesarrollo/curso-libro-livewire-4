<div x-cloak x-data="{ show: false }"
    ...
    class="absolute w-screen max-w-md top-0 end-0 bottom-0">
        <div class="bg-white border-l min-h-full shadow-lg border-zinc-300 p-4 relative dark:bg-zinc-900 dark:border-zinc-800">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($folder): ?>
                <strong class="text-black text-lg dark:text-gray-300"><?php echo e($folder->name); ?></strong>
                ...
                <div class="mt-4">
                    ...
                    <dl class="mt-2 divide-y divide-gray-200 border-b border-t border-gray-200 dark:divide-zinc-600 dark:border-zinc-600">
                        <div class="flex justify-between py-3 text-sm font-medium">
                            ...
                            <dd class="text-gray-900 dark:text-gray-300"><?php echo e($folder->created_at->diffForHumans()); ?></dd>
                        </div>
                        <div class="flex justify-between py-3 text-sm font-medium">
                            <dt class="text-gray-500 dark:text-gray-200"><?php echo e(__('livewire-filemanager::filemanager.modified')); ?></dt>
                            <dd class="text-gray-900 dark:text-gray-300"><?php echo e($folder->updated_at->diffForHumans()); ?></dd>
                        </div>
                    </dl>
                </div>
...
<?php /**PATH /Users/andrescruz/Herd/livewirestore/vendor/livewire-filemanager/filemanager/src/../resources/views/livewire/folder-panel.blade.php ENDPATH**/ ?>