<svg <?php echo e($attributes); ?> xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" fill="#FFFFFF">
	...
	<linearGradient id="folder-icon" x1="48" x2="48" y1="24" y2="78" gradientUnits="userSpaceOnUse">
		<stop offset="0" stop-color="#fff" stop-opacity="0"/>
		<stop offset="1" stop-color="#ffd75e" stop-opacity=".3"/>
	</linearGradient>
	<path fill="url(#folder-icon)" d="M45,24l-4.2426,4.2426C39.6321,29.3679,38.106,30,36.5147,30H6v47c0,0.5523,0.4477,1,1,1h82 c0.5523,0,1-0.4477,1-1V27c0-1.6569-1.3431-3-3-3H45z"/>
...
<?php /**PATH /Users/andrescruz/Herd/livewirestore/vendor/livewire-filemanager/filemanager/src/../resources/views/components/icons/folder.blade.php ENDPATH**/ ?>